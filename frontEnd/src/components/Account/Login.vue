    ...
    <div>
      <el-form :model="form" :rules="rules2" ref="form" label-position="left" label-width="0px" class="demo-ruleForm card-box loginform">
        ...
        <el-form-item v-show="requireVerify" prop="verifyCode">
          <el-input type="text" v-model="form.verifyCode" placeholder="验证码" class="w-150"></el-input>
...
.whgbg{
  ...
  overflow: hidden;
  height: 100%;
  background: url('../../assets/images/whgBG.jpg') no-repeat left top;
  background-size: 100%; */
}
.verify-pos {
	position: absolute;
...
.card-box {
  ...
  box-shadow: 0 0 90px #879ea4;
  -webkit-box-shadow: 0 0 90px #879ea4;
}
